        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-6">
              {/* Essential Cookies */}
              <div className="border border-green-200 dark:border-green-900/40 rounded-lg p-6 bg-green-50 dark:bg-green-900/30">
                <div className="flex items-start gap-3 mb-3">
                  <Settings className="w-6 h-6 text-green-600 mt-1" />
                  <h3 className="text-lg font-semibold text-green-900 dark:text-green-300">Essential Cookies</h3>
                </div>
                <p className="text-green-800 dark:text-green-300 mb-3">
                  These cookies are necessary for the website to function and cannot be switched off in our systems.
                </p>
                <ul className="list-disc list-inside text-green-800 dark:text-green-300 space-y-1 ml-4">
              ...
              {/* Analytics Cookies */}
              <div className="border border-blue-200 dark:border-blue-900/40 rounded-lg p-6 bg-blue-50 dark:bg-blue-900/30">
                <div className="flex items-start gap-3 mb-3">
                  <BarChart3 className="w-6 h-6 text-blue-600 mt-1" />
                  <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-300">Analytics Cookies</h3>
                </div>
                <p className="text-blue-800 dark:text-blue-300 mb-3">
                  These cookies help us understand how visitors interact with our website by collecting and reporting information anonymously.
                </p>
                <ul className="list-disc list-inside text-blue-800 dark:text-blue-300 space-y-1 ml-4">
              ...
              {/* Marketing Cookies */}
              <div className="border border-purple-200 dark:border-purple-900/40 rounded-lg p-6 bg-purple-50 dark:bg-purple-900/30">
                <div className="flex items-start gap-3 mb-3">
                  <Target className="w-6 h-6 text-purple-600 mt-1" />
                  <h3 className="text-lg font-semibold text-purple-900 dark:text-purple-300">Marketing Cookies</h3>
                </div>
                <p className="text-purple-800 dark:text-purple-300 mb-3">
                  These cookies are used to track visitors across websites to display relevant advertisements.
                </p>
                <ul className="list-disc list-inside text-purple-800 dark:text-purple-300 space-y-1 ml-4">
              ...
              {/* Functional Cookies */}
              <div className="border border-indigo-200 dark:border-indigo-900/40 rounded-lg p-6 bg-indigo-50 dark:bg-indigo-900/30">
                <div className="flex items-start gap-3 mb-3">
                  <Settings className="w-6 h-6 text-indigo-600 mt-1" />
                  <h3 className="text-lg font-semibold text-indigo-900 dark:text-indigo-300">Functional Cookies</h3>
                </div>
                <p className="text-indigo-800 dark:text-indigo-300 mb-3">
                  These cookies enable the website to provide enhanced functionality and personalization.
                </p>
                <ul className="list-disc list-inside text-indigo-800 dark:text-indigo-300 space-y-1 ml-4">
          ...
          {/* Cookie Management */}
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">4. Managing Your Cookie Preferences</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">5. Impact of Disabling Cookies</h2>
            <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-4">
          ...
          {/* Updates to Policy */}
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">6. Updates to This Policy</h2>
            <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
