    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <button
            onClick={onBack}
            className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 mb-6 transition-colors"
           >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Refund Policy</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">2. Refund Eligibility</h2>
            </div>
            <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-4">Refunds may be available in the following situations:</p>

            <div className="space-y-4">
              <div className="border border-green-200 rounded-lg p-4 bg-green-50 dark:bg-green-900/30">
              ...
              <div className="border border-red-200 rounded-lg p-4 bg-red-50 dark:bg-red-900/30">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">3. Non-Refundable Situations</h2>
            </div>
            <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-4">Refunds are generally not available in these circumstances:</p>
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">4. Refund Processing Timeline</h2>
            </div>
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="border border-blue-200 rounded-lg p-4">
                  <h3 className="font-semibold text-blue-900 mb-2">Approval Time</h3>
                  <p className="text-blue-800 dark:text-blue-300 text-sm">Most refund requests are reviewed within 24-48 hours</p>
                </div>
                <div className="border border-blue-200 rounded-lg p-4">
                  <h3 className="font-semibold text-blue-900 mb-2">Processing Time</h3>
                  <p className="text-blue-800 dark:text-blue-300 text-sm">Approved refunds are processed within 5-7 business days</p>
                </div>
              </div>
              <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="text-gray-700 dark:text-gray-200 leading-relaxed">To request a refund:</p>
              <ol className="list-decimal list-inside text-gray-700 dark:text-gray-200 space-y-2 ml-4">
              ...
              <div className="bg-orange-50 dark:bg-orange-900/30 border border-orange-200 rounded-lg p-4">
          ...
          {/* Refund Methods */}
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">6. Refund Methods</h2>
            <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-4">Refunds are processed using the original payment method:</p>

            <div className="grid md:grid-cols-2 gap-4">
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Credit/Debit Cards</h3>
                <p className="text-gray-700 dark:text-gray-200 text-sm">3-5 business days for processing</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Digital Wallets</h3>
                <p className="text-gray-700 dark:text-gray-200 text-sm">1-3 business days for processing</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Bank Transfers</h3>
                <p className="text-gray-700 dark:text-gray-200 text-sm">5-7 business days for processing</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Platform Credits</h3>
                <p className="text-gray-700 dark:text-gray-200 text-sm">Instant credit to your account</p>
              </div>
            </div>
          </section>
          ...
          {/* Cancellation Fees */}
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">7. Cancellation Fees</h2>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300 dark:border-gray-700">
                <thead>
                  <tr className="bg-gray-50 dark:bg-gray-900">
                    <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Cancellation Timing</th>
                    <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Refund Amount</th>
                    <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Fee</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">More than 7 days before</td>
                  ...
                  <tr className="bg-gray-50 dark:bg-gray-900">
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">3-7 days before</td>
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">80%</td>
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">20% of booking value</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">24-72 hours before</td>
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">50%</td>
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">50% of booking value</td>
                  </tr>
                  <tr className="bg-gray-50 dark:bg-gray-900">
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Less than 24 hours</td>
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">0%</td>
                    <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">100% of booking value</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="border-t pt-8">
            ...
            <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
              <p className="text-gray-700 dark:text-gray-200"><strong>Email:</strong> refunds@islakayd.com</p>
              <p className="text-gray-700 dark:text-gray-200"><strong>Support Portal:</strong> https://support.islakayd.com/refunds</p>
              <p className="text-gray-700 dark:text-gray-200"><strong>Phone:</strong> 1-800-ISLAKAYD (available 9 AM - 6 PM EST)</p>
            </div>
          </section>
        </div>
      </div>
