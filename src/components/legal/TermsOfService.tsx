    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">4. Equipment Listings and Rentals</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">For Equipment Owners:</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">For Equipment Renters:</h3>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-1 ml-4">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">5. Payment Terms</h2>
            </div>
            <div className="space-y-4">
              <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">6. Prohibited Activities</h2>
            </div>
            <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-4">You agree not to:</p>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-2 ml-4">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">7. Liability and Disclaimers</h2>
            </div>
            <div className="space-y-4">
              <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
          ...
          <section className="border-t dark:border-gray-700 pt-8">
            ...
            <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700/40 rounded-lg">
              <p className="text-gray-700 dark:text-gray-200"><strong>Email:</strong> legal@islakayd.com</p>
              <p className="text-gray-700 dark:text-gray-200"><strong>Address:</strong> Islakayd Pty Ltd, Legal Department, Level 25, 123 Pitt Street, Sydney, NSW 2000, Australia</p>
            </div>
          </section>
        </div>
      </div>
