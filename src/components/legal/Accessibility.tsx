      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Accessibility Features</h2>

            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Navigation & Structure</h3>
            ...
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Visual Accessibility</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Screen Reader Support</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Motor Accessibility</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Assistive Technologies</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Mobile Accessibility</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Content Accessibility</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Reporting Accessibility Issues</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Continuous Improvement</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Legal Compliance</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
