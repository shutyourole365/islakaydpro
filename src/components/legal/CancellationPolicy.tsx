    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Cancellation Policy</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">For Renters</h2>

            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Free Cancellation</h3>
            ...
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Modified Cancellation (24-48 hours before pickup)</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Late Cancellation (Less than 24 hours before pickup)</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">No-Show Policy</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">For Equipment Owners</h2>

            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Owner Cancellation Rights</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mt-6 mb-3">Force Majeure</h3>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Modification Policy</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Refund Processing</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Dispute Resolution</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
