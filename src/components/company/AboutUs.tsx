          ...
          <div className="px-8 py-16">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-16">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Leadership Team</h2>
                <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-1">Emma Rodriguez</h3>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-8">
                <div className="flex items-center justify-center mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Global Presence</h2>
                </div>
                ...
                <div className="grid md:grid-cols-4 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">North America</div>
                    <div className="text-gray-600 dark:text-gray-300">USA, Canada, Mexico</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">Europe</div>
                    <div className="text-gray-600 dark:text-gray-300">UK, Germany, France, Spain</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">Asia Pacific</div>
                    <div className="text-gray-600 dark:text-gray-300">Australia, Japan, Singapore</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">Rest of World</div>
                    <div className="text-gray-600 dark:text-gray-300">Brazil, UAE, South Africa</div>
                  </div>
                </div>
              </div>
            </div>
