    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg p-4 md:p-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center gap-4">
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <span className="font-semibold text-gray-900 dark:text-white">Cookie Preferences</span>
        </div>
        ...
        <div className="p-6 space-y-6">
          <div>
            ...
            <label className="flex items-center">
              ...
              />
              <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Always enabled</span>
            </label>
          </div>

          <div>
            <h3 className="font-medium text-gray-900 dark:text-white mb-2">Analytics Cookies</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
            ...
            <label className="flex items-center">
              <input
                ...
                className="rounded border-gray-300 text-teal-500 focus:ring-teal-500"
              />
              <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Google Analytics</span>
            </label>
          </div>

          <div>
            <h3 className="font-medium text-gray-900 dark:text-white mb-2">Functional Cookies</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
            ...
            <label className="flex items-center">
              <input
                ...
                className="rounded border-gray-300 text-teal-500 focus:ring-teal-500"
              />
              <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Language and location preferences</span>
            </label>
          </div>

          <div>
            <h3 className="font-medium text-gray-900 dark:text-white mb-2">Marketing Cookies</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
            ...
            <label className="flex items-center">
              <input
                ...
                className="rounded border-gray-300 text-teal-500 focus:ring-teal-500"
              />
              <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Targeted advertising</span>
            </label>
          </div>
        </div>
