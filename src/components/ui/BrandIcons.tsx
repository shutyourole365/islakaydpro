...
// Brand logos were removed from lucide-react in v1 (https://github.com/lucide-icons/lucide
// dropped brand icons). These are drop-in replacements with the same icon API surface
// (className, size via width/height inherit) used by this app.
