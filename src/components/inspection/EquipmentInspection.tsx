    ...
    <div className={className}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700 mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Equipment Inspection</h2>
            <p className="text-gray-600 dark:text-gray-400">{equipment.title} - Pre-rental Safety Check</p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{currentCategoryData.title}</h3>
                  ...
                  <div key={item.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                          ...
                          <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                              item.status === 'pass'
                                ...
                                : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-green-50 dark:hover:bg-green-900/20 hover:text-green-700 dark:hover:text-green-400'
                            }`}
                          >
                        ...
                        {/* Photo Upload */}
                        <div>
                          <button className="flex items-center gap-2 px-3 py-2 text-sm text-blue-600 hover:text-blue-700 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors">
        ...
        <div className={`mt-6 p-4 rounded-lg ${
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`font-medium ${
              overallStatus === 'pass' ? 'text-green-800 dark:text-green-300' : 'text-red-800 dark:text-red-300'
            }`}>
              Inspection {overallStatus === 'pass' ? 'Passed' : 'Failed'}
            </span>
          </div>
          <p className={`text-sm mt-1 ${
            overallStatus === 'pass' ? 'text-green-700 dark:text-green-400' : 'text-red-700 dark:text-red-400'
          }`}>
            {overallStatus === 'pass'
