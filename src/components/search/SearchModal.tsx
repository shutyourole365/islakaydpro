...
export default function SearchModal({ isOpen, onClose, onSearch }: SearchModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-20 px-4">
      ...
      <div className="relative w-full max-w-3xl bg-white dark:bg-gray-900 rounded-3xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-4 duration-300">
        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-4">
            <div className="flex-1 flex items-center gap-3 bg-gray-50 dark:bg-gray-800 rounded-2xl px-4 py-3">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300">
            ...
            <select
              ...
              className="px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 focus:outline-none focus:border-teal-500"
            >
              {categories.map((cat) => (
        ...
        {showFilters && (
          <div className="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-950">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    <input
                      ...
                      placeholder="Min"
                      className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 focus:outline-none focus:border-teal-500"
                    />
                  </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  {['Any', 'New', 'Excellent', 'Good'].map((condition) => (
                    <button
                      key={condition}
                      className="px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-300 hover:border-teal-500 hover:text-teal-600 transition-colors"
                     >
                      {condition}
                    </button>
                  ))}
                ...
                <div className="space-y-2">
                  {recentSearches.map((search, index) => (
                    <button
                      ...
                      className="flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors text-left"
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {trendingSearches.map((item, index) => (
                    <button
                      ...
                      className="flex items-center justify-between px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/40 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-left"
                    >
                      <div>
                    ...
                    {suggestions.map((suggestion) => (
                      <li key={suggestion}>
                        <button
                          ...
                          className="w-full text-left px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 text-gray-700 dark:text-gray-200 text-sm flex items-center gap-2"
                        >
