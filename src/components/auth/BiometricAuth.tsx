...
export default function BiometricAuth({ onSuccess, onError, userId }: BiometricAuthProps) {
  ...
  if (!capabilities?.available) {
    return (
      <div className="p-4 bg-gray-50 dark:bg-gray-700/40 rounded-xl border border-gray-200 dark:border-gray-700">
  ...
  return (
    <div className="space-y-4">
      <div className="p-6 bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-teal-900/20 dark:to-emerald-900/20 rounded-2xl border border-teal-100 dark:border-teal-800/50">
        ...
        {isRegistered ? (
          ...
          <button
            ...
            className="w-full py-4 bg-white dark:bg-gray-800 border-2 border-teal-500 text-teal-600 dark:text-teal-400 font-semibold rounded-xl hover:bg-teal-50 dark:hover:bg-teal-900/30 transition-all disabled:opacity-50 flex items-center justify-center gap-3"
           >
            {isRegistering ? (
              <>
