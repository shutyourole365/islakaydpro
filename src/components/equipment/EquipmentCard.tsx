...
const EquipmentCard = memo(function EquipmentCard({
  ...
  if (variant === 'horizontal') {
    return (
      <div
        ...
        className="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600 hover:shadow-xl transition-all duration-300 flex cursor-pointer"
      >
        ...
        <div className="flex-1 p-4 flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700 mt-3">
            <div>
              <span className="text-xl font-bold text-gray-900 dark:text-white">${equipment.daily_rate}</span>
  ...
  if (variant === 'compact') {
    return (
      <div
        onClick={() => onEquipmentClick(equipment)}
        className="group bg-white dark:bg-gray-800 rounded-xl overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600 hover:shadow-lg transition-all duration-300 cursor-pointer"
      >
          ...
          <button
            ...
            className={`absolute top-2 right-2 w-8 h-8 rounded-full flex items-center justify-center transition-all ${
              isFavorite
                ...
                : 'bg-white/90 dark:bg-gray-700/90 text-gray-600 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400'
            }`}
          >
        ...
        <div className="p-3">
          <h3 className="font-medium text-gray-900 dark:text-white text-sm line-clamp-1">{equipment.title}</h3>
          <div className="flex items-center justify-between mt-2">
            <span className="font-bold text-gray-900 dark:text-white">${equipment.daily_rate}</span>
  ...
  return (
    <div
      onClick={() => onEquipmentClick(equipment)}
      className="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600 hover:shadow-xl transition-all duration-300 cursor-pointer"
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2">
          <button
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
              isFavorite
                ...
                : 'bg-white/90 dark:bg-gray-700/90 text-gray-600 dark:text-gray-300 hover:bg-white dark:hover:bg-gray-600 hover:text-red-500 dark:hover:text-red-400'
            }`}
          >
          ...
          {showCompareButton && onAddToComparison && (
            <button
              ...
              className="w-10 h-10 rounded-full bg-white/90 dark:bg-gray-700/90 text-gray-600 dark:text-gray-300 hover:bg-purple-500 hover:text-white flex items-center justify-center transition-all duration-300"
        ...
        <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
          ...
          {equipment.owner?.is_verified && (
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full">
      ...
      <div className="p-5">
        ...
        {showQuickBook && (
          <button
            ...
            className="w-full mt-4 py-3 bg-brand-gradient text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-pop"
          >
            View & Book
          </button>
        )}
