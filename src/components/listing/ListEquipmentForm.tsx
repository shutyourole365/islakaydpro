...
export default function ListEquipmentForm({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-gray-50 dark:bg-gray-950">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span
                      className={`text-sm font-medium ${
                        s <= step ? 'text-gray-900 dark:text-white' : 'text-gray-400'
                      }`}
                    >
                      {s === 1 && 'Details'}
                      {s === 2 && 'Photos'}
          ...
          <div className="max-w-3xl mx-auto px-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 focus:outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:text-white focus:outline-none focus:border-teal-500 bg-white dark:bg-gray-800"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 focus:outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 resize-none"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 focus:outline-none focus:border-teal-500"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1.5">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-3">
                    <input
                      ...
                      className="flex-1 px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 focus:outline-none focus:border-teal-500"
                    />
                    <button
                      type="button"
                      onClick={addFeature}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {formData.features.map((feature, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-700 dark:text-gray-200 rounded-full text-sm"
                      >
                        {feature}
                        <button
                          type="button"
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div className="border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl p-12 text-center">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-3">JPEG, PNG, WebP or GIF. Max 10MB per photo.</p>
                  {uploadError && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="0.00"
                        className="w-full pl-12 pr-16 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 focus:outline-none focus:border-teal-500"
                      />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="0.00"
                        className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 focus:outline-none focus:border-teal-500"
                      />
                    </div>
            ...
            {step === 4 && (
              <div className="space-y-6">
                ...
                <div className="bg-green-50 dark:bg-green-900/30 rounded-xl p-4 flex items-start gap-3">
