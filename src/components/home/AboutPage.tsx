    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Safety & Security</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
        ...
        <div className="text-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/help"
                className="inline-flex items-center px-6 py-3 border-2 border-teal-500 text-teal-500 dark:text-teal-400 font-medium rounded-xl hover:bg-teal-50 dark:hover:bg-teal-900/30 transition-colors"
              >
                Visit Help Center
              </a>
            </div>
