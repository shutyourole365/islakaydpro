        ...
        <div className="text-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/help"
                className="inline-flex items-center px-6 py-3 border-2 border-teal-500 text-teal-500 dark:text-teal-400 font-medium rounded-xl hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors"
              >
                Visit Help Center
              </a>
            </div>
