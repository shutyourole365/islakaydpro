    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">Payments & Payouts</h1>
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
                      ...
                      <p className="text-3xl font-bold text-gray-900 dark:text-white">
                        ...
                        <span className="text-base font-normal text-gray-400 dark:text-gray-500 ml-1">AUD</span>
                      </p>
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Ready to be paid out</p>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
                      <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-2">
                      ...
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">In transit from bookings</p>
                    </div>
                  </div>
                )}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-4">How payouts work</h3>
              ...
              <div className="space-y-4">
                {!connectStatus?.isOnboarded ? (
                  <div className="text-center py-16 text-gray-400 dark:text-gray-500">
                    ...
                    <p className="font-medium text-gray-600 dark:text-gray-400">No payout history yet</p>
                  ...
                  <div className="text-center py-16 text-gray-400 dark:text-gray-500">
                    ...
                    <p className="font-medium text-gray-600 dark:text-gray-400">No payouts yet</p>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                    <div className="divide-y divide-gray-50 dark:divide-gray-700">
                      {payouts.map((p) => (
                        <div key={p.id} className="flex items-center gap-4 px-5 py-4 hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                          <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${
                            p.status === 'completed' ? 'bg-green-100 dark:bg-green-900/30' : p.status === 'pending' ? 'bg-amber-100 dark:bg-amber-900/30' : 'bg-red-100 dark:bg-red-900/30'
                          }`}>
                            {p.status === 'completed' ? (
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
                              ...
                              <span className={`font-medium ${
                                p.status === 'completed' ? 'text-green-600 dark:text-green-400' : p.status === 'pending' ? 'text-amber-600 dark:text-amber-400' : 'text-red-500'
                              }`}>
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-xs text-gray-400 dark:text-gray-500">AUD</p>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${
                      connectStatus?.isOnboarded ? 'bg-green-100 dark:bg-green-900/30' : 'bg-gray-100 dark:bg-gray-700'
                    }`}>
                      {connectStatus?.isOnboarded ? (
                    ...
                    <div className="flex-1">
                      ...
                      {connectStatus?.isOnboarded && (
                        <button
                          onClick={handleConnectStripe}
                          disabled={connectLoading}
                          className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
                        >
