...
export default function MaintenanceScheduler({ equipment: propEquipment, className = '' }: MaintenanceSchedulerProps) {
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      case 'critical': return 'text-red-600 bg-red-100 dark:text-red-300 dark:bg-red-900/30';
      case 'high': return 'text-orange-600 bg-orange-100 dark:text-orange-300 dark:bg-orange-900/30';
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'overdue': return 'text-red-600 bg-red-100 dark:text-red-300 dark:bg-red-900/30';
      case 'scheduled': return 'text-blue-600 bg-blue-100 dark:text-blue-300 dark:bg-blue-900/30';
      case 'cancelled': return 'text-gray-600 bg-gray-100 dark:text-gray-400 dark:bg-gray-700';
      default: return 'text-gray-600 bg-gray-100 dark:text-gray-400 dark:bg-gray-700';
    }
  };
    ...
    <div className={className}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700 mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Maintenance Scheduler</h2>
            <p className="text-gray-600 dark:text-gray-400">Keep your equipment running smoothly</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button aria-label="Download schedule" className="p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800">
            ...
            <div className="text-2xl font-bold text-red-900 dark:text-red-200">{overdueTasks.length}</div>
          </div>

          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
            <div className="flex items-center gap-2 mb-2">
              <Clock className="w-5 h-5 text-blue-600" />
              <span className="text-sm font-medium text-blue-800 dark:text-blue-300">This Week</span>
            </div>
            <div className="text-2xl font-bold text-blue-900 dark:text-blue-200">{upcomingTasks.length}</div>
          </div>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-purple-800 dark:text-purple-300">Total Tasks</span>
            </div>
            <div className="text-2xl font-bold text-purple-900 dark:text-purple-200">{maintenanceTasks.length}</div>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-sm"
                      >
            ...
            <div key={status} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
              ...
              <div className="space-y-3">
                {maintenanceTasks
                  ...
                  .slice(0, 5)
                  .map((task) => (
                    <div key={task.id} className="bg-white dark:bg-gray-800 p-3 rounded border border-gray-200 dark:border-gray-600">
                      <h4 className="font-medium text-sm text-gray-900 dark:text-white mb-1">{task.title}</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">{task.equipmentName}</p>
      ...
      {filteredTasks.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No maintenance tasks found</h3>
          <p className="text-gray-600 dark:text-gray-400">Try adjusting your filters or add a new maintenance task.</p>
        </div>
      )}
    </div>
  );
