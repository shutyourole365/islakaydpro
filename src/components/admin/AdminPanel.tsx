      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <button className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 hover:border-teal-200 dark:hover:border-teal-700 transition-all text-left">
                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center">
                  <Users className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">Verify Users</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">15 pending verifications</p>
                </div>
              </button>
              ...
              <button className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 hover:border-teal-200 dark:hover:border-teal-700 transition-all text-left">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">Review Listings</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">8 awaiting approval</p>
                </div>
              </button>
              ...
              <button className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 hover:border-teal-200 dark:hover:border-teal-700 transition-all text-left">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">Handle Reports</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">23 open reports</p>
                </div>
              </button>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-xl">
            ...
            <div className="flex gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-400"
                />
              </div>
              <button className="flex items-center gap-2 px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-gray-700 dark:text-gray-300">
                ...
                <tbody>
                  {users.map((user) => (
                    <tr key={user.id} className="border-t border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{user.listings}</td>
                      <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{user.bookings}</td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-1">
                          <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg" title="View">
                            <Eye className="w-4 h-4 text-gray-600 dark:text-gray-400" />
                          </button>
                          <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg" title="Edit">
                            <Edit className="w-4 h-4 text-gray-600 dark:text-gray-400" />
                          </button>
                          <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg" title="Email">
                            <Mail className="w-4 h-4 text-gray-600 dark:text-gray-400" />
                          </button>
                          <button className="p-2 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg" title="Ban">
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
              <table className="w-full">
                ...
                <tbody>
                  {reports.map((report) => (
                    <tr key={report.id} className="border-t border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <td className="px-6 py-4">
                        <span className="capitalize text-gray-900 dark:text-white font-medium">{report.type}</span>
                      </td>
                      <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{report.reason}</td>
                      <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{report.reporter}</td>
                      <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{report.reported}</td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-1">
                          ...
                          <button className="p-2 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg" title="Resolve">
                            <CheckCircle2 className="w-4 h-4 text-green-600 dark:text-green-400" />
                          </button>
                          <button className="p-2 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg" title="Dismiss">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">Service Fee Rate</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Platform fee charged on bookings</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-20 px-3 py-2 border border-gray-200 dark:border-gray-600 rounded-lg text-center focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white dark:bg-gray-600 text-gray-900 dark:text-white"
                    />
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">Require Verification</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Users must verify identity to list equipment</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">Auto-approve Listings</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Verified users can list without review</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Take the platform offline for maintenance</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
        ...
        {activeTab === 'equipment' && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-12 border border-gray-100 dark:border-gray-700 shadow-sm text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Equipment Management</h2>
            <p className="text-gray-500 dark:text-gray-400">View and manage all equipment listings on the platform.</p>
          </div>
        )}
      </div>
    </div>
