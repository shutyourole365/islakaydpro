          ...
          <div className="px-8 py-16">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-16">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {contactMethods.map((method, index) => (
                    <div key={index} className="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-6 text-center hover:shadow-md transition-shadow">
              ...
              <div className="mb-16">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-8">
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <select className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <div className="flex items-center">
                      <input
                        type="checkbox"
                        id="newsletter"
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-700 dark:bg-gray-800 rounded"
                      />
                      <label htmlFor="newsletter" className="ml-2 text-sm text-gray-600 dark:text-gray-300">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {offices.map((office, index) => (
                    <div key={index} className="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-6">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm mb-3 whitespace-pre-line">{office.address}</p>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 text-center">
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">24 hours a day, 7 days a week</p>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Critical issues only</p>
