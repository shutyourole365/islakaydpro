          ...
          <div className="px-8 py-16">
            <div className="max-w-4xl mx-auto">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {section.guidelines.map((guideline, idx) => (
                          <div key={idx} className="flex items-start">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 text-sm">{guideline}</p>
                          </div>
                        ))}
                      </div>
                    </div>
              ...
              <div className="mb-16">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-900/40 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    <Wrench className="w-6 h-6 text-yellow-600 dark:text-yellow-400 mr-3" />
              ...
              <div className="mb-16">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {emergencyContacts.map((contact, index) => (
                    <div key={index} className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-900/40 rounded-lg p-6">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mb-2">{contact.description}</p>
              ...
              {/* Safety Reporting */}
              <div className="bg-red-50 dark:bg-red-900/30 rounded-lg p-8">
